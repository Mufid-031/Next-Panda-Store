    ...
    return (
        <Auth type="login">
            <form className="flex flex-col my-5">
                ...
                <button className="bg-slate-500 p-2 rounded-md mt-5 font-bold text-lg text-slate-300 hover:bg-lime-500 hover:text-slate-900 transition duration-700"><Link href={"/products"}>Login</Link></button>
            </form>
        </Auth>
    )
}
